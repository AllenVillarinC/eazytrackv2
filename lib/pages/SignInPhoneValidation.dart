...
class SignInPhoneValidationPage extends StatefulWidget {
  const SignInPhoneValidationPage({super.key});

  @override
  State<SignInPhoneValidationPage> createState() =>
      _SignInPhoneValidationPageState();
}

class _SignInPhoneValidationPageState extends State<SignInPhoneValidationPage> {
  Widget buildPinPut() {
    return Pinput(
